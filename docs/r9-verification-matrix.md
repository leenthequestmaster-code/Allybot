...
| CI parity and artifact | GitHub Actions typecheck/build/parity/regression; sanitized artifact only | CI run dan artifact hash | Pending |
| Panel deployment | Artifact CI commit yang sama, decompress HTTP 204, archive cleanup, restart, `event storage initialized`, smoke | Panel evidence | Pending |
