...
const targetJid = '6283197859956@s.whatsapp.net'
...
function groupMessage(id, senderJid, text) {
  return { id, remoteJid: '120363000000000000@g.us', senderJid, text, timestamp: Date.now(), fromMe: false }
}
...
test('DeveloperModeService enforces active-target uniqueness and bounded audit retention', () => {
  ...
  try {
    ...
    assert.throws(
      () => service.activate(ownerJid, '6283197859957@s.whatsapp.net', 'observer', 60_000, 'capacity'),
      /activation limit reached/,
    )
    service.evaluate('6283197859958@s.whatsapp.net')
    service.evaluate('6283197859959@s.whatsapp.net')
