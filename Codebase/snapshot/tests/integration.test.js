...
class FakeCore {
  ...
  async listParticipatingGroups() {
    return [
      { jid: '120363000000000001-<jid-redacted@g.us>', subject: 'Alpha\nRoom' },
      { jid: '120363000000000002-<jid-redacted@g.us>', subject: 'Beta Room' },
...
test('Public owner profile image failure uses text fallback without raw error logging', async () => {
  ...
  await owner.handler({
    ...
    config: { botOwnerJid: '<jid-redacted@s.whatsapp.net>' },
    prefix: '!',
    whatsapp: {
