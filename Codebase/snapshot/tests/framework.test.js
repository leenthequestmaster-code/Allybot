...
test('isJid accepts only strict WhatsApp JID formats', () => {
  const valid = [
    ...
    '<phone-redacted>:12@s.whatsapp.net',
    '<jid-redacted@g.us>',
    '120363012345678901-<jid-redacted@g.us>',
    '<jid-redacted@lid>',
    '<jid-redacted@newsletter>',
    '<jid-redacted@broadcast>',
    'status@broadcast',
  ]
  ...
  const invalid = [
    ...
    'roleplay@g.us',
    'status@g.us',
    '<jid-redacted@s.whatsapp.net>.evil.com',
    '<jid-redacted@s.whatsapp.net>/../secrets',
    '@s.whatsapp.net',
    '<phone-redacted>@',
    '<phone-redacted>@s whatsapp net',
    '<jid-redacted@S.WHATSAPP.NET>',
    ' <jid-redacted@s.whatsapp.net>',
    '<jid-redacted@s.whatsapp.net> ',
    '<phone-redacted>:s.whatsapp.net@s.whatsapp.net',
    '<phone-redacted>::1@s.whatsapp.net',
    '-<jid-redacted@g.us>',
    '120363012345678901--<jid-redacted@g.us>',
...
test('isGroupJid only accepts numeric WhatsApp group JIDs', () => {
  assert.equal(isGroupJid('<jid-redacted@g.us>'), true)
  assert.equal(isGroupJid('120363012345678901-<jid-redacted@g.us>'), true)
  assert.equal(isGroupJid('<jid-redacted@s.whatsapp.net>'), false)
  assert.equal(isGroupJid('roleplay@g.us'), false)
  assert.equal(isGroupJid('<jid-redacted@newsletter>'), false)
