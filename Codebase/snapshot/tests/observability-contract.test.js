...
const actorJid = '628130000010@s.whatsapp.net'
const resourceJid = '120363100000010000@g.us'
...
test('observability contract exposes Developer Mode audit as bounded hashes and outcomes', () => {
  ...
  service.initialize({})
  try {
    const owner = '628130000011@s.whatsapp.net'
    const target = '628130000012@s.whatsapp.net'
