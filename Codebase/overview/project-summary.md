...
The export describes Allybot as observed at commit `e7ad6fa49e5c8516e38ae59c4ab310d153db00a7`. It contains 256 allowlisted source/document files, 6278 symbol rows, 847 import rows, 14256 call rows, 189 command rows, 121 service/plugin registrations, 336 test rows, and 14 dependency rows.
